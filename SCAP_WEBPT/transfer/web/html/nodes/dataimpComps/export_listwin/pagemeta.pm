...
<PageMeta i18nName="" caption="省属企业交易导入列表"  controllerClazz="nc.scap.library.transfer.export.ExportListWinCtrl"  id="export_listwin" sourcePackage="transfer/src/public/" windowType="win">
    ...
    <Connectors>
        ...
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="dataimpComps.export_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
