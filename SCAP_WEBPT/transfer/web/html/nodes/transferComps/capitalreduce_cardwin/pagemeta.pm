...
<PageMeta caption="不同比例增资卡片" controllerClazz="nc.scap.transfer.trs.CapitalReduceCardWinMainViewCtr" id="capitalreduce_cardwin" sourcePackage="transfer/src/public/" windowType="win">
