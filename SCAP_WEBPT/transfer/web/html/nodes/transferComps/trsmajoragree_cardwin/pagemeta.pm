...
<PageMeta caption="重大资产协议转让卡片" controllerClazz="nc.scap.transfer.trs.TrsCardWinMajorAgreeViewCtr" id="trsmajoragree_cardwin" sourcePackage="transfer/src/public/" windowType="win">
