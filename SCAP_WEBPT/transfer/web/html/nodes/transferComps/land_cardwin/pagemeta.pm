...
<PageMeta caption="土地占有简况卡片" controllerClazz="nc.scap.transfer.land.LandCardWinCtrl" id="land_cardwin" sourcePackage="transfer/src/public/" windowType="win">
	...
	<Connectors>
        <Connector connType="7" id="proxyout_proxyAfterSavePlugout_afterSavePlugout" pluginId="proxyAfterSavePlugout" plugoutId="afterSavePlugout" source="main" sourceWindow="" target="transferComps.land_cardwin" targetWindow="">
        </Connector>
