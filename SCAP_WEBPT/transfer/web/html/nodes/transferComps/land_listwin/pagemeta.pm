...
<PageMeta i18nName="" caption="土地占有简况列表"  controllerClazz="nc.scap.transfer.land.LandListWinCtrl"  id="land_listwin" sourcePackage="transfer/src/public/" windowType="win">
    ...
    <Connectors>
        ...
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="transferComps.land_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
