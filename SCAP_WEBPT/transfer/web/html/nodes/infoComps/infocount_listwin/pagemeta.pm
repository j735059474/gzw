...
<PageMeta i18nName="" caption="产权转让信息统计列表"  controllerClazz="nc.scap.transfer.infocount.InfocountListWinCtrl"  id="infocount_listwin" sourcePackage="transfer/src/public/" windowType="win">
    ...
    <Connectors>
        ...
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="infoComps.infocount_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
