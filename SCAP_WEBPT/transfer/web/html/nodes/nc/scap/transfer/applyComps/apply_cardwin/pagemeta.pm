...
<PageMeta caption="产权交易申请卡片" controllerClazz="nc.scap.transfer.apply.ApplyCardWinCtrl" id="apply_cardwin" sourcePackage="transfer/src/public/" windowType="win">
	...
	<Connectors>
        <Connector connType="7" id="proxyout_proxyAfterSavePlugout_afterSavePlugout" pluginId="proxyAfterSavePlugout" plugoutId="afterSavePlugout" source="main" sourceWindow="" target="nc.scap.transfer.applyComps.apply_cardwin" targetWindow="">
        </Connector>
