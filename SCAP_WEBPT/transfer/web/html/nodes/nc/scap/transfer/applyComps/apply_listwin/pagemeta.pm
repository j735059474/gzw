...
<PageMeta i18nName="" caption="产权交易申请列表"  controllerClazz="nc.scap.transfer.apply.ApplyListWinCtrl"  id="apply_listwin" sourcePackage="transfer/src/public/" windowType="win">
    ...
    <Connectors>
        ...
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="nc.scap.transfer.applyComps.apply_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
