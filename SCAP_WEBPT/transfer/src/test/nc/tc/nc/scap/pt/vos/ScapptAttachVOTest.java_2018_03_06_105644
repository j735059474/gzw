...
public class ScapptAttachVOTest extends BaseTestCase {
  ScapptAttachVO scapptAttachVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    scapptAttachVO=NCLocator.getInstance().lookup(ScapptAttachVO.class);
  }
  ...
  public void getPk_transfer_h(  Map<String,ArrayList<String>> dp){
    ...
    String retObj="";
    retObj=scapptAttachVO.getPk_transfer_h();
  ...
  public void setPk_transfer_h(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptAttachVO.setPk_transfer_h(newPk_transfer_h);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getPk_attach(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptAttachVO.getPk_attach();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_attach(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String newPk_attach=(String)dp.get("newpk_attach").get(0);
    
    //Invoke tested method
    scapptAttachVO.setPk_attach(newPk_attach);
  ...
  public void getAttach_name(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptAttachVO.getAttach_name();
  ...
  public void setAttach_name(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptAttachVO.setAttach_name(newAttach_name);
  ...
  public void setDef1(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptAttachVO.setDef1(newDef1);
  ...
  public void setDef2(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptAttachVO.setDef2(newDef2);
  ...
  public void setDef3(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptAttachVO.setDef3(newDef3);
  ...
  public void setDef4(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptAttachVO.setDef4(newDef4);
  ...
  public void setDef5(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptAttachVO.setDef5(newDef5);
  ...
  public void getSubmitstate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptAttachVO.getSubmitstate();
  ...
  public void setSubmitstate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptAttachVO.setSubmitstate(newSubmitstate);
  ...
  public void getParentPKFieldName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptAttachVO.getParentPKFieldName();
  ...
  public void getPKFieldName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptAttachVO.getPKFieldName();
  ...
  public void getTableName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptAttachVO.getTableName();
  ...
  public void getDefaultTableName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=ScapptAttachVO.getDefaultTableName();
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    IVOMeta retObj=null;
    retObj=scapptAttachVO.getMetaData();
