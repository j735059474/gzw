...
public class ScapptExportTransHVOTest extends BaseTestCase {
  ScapptExportTransHVO scapptExportTransHVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    scapptExportTransHVO=NCLocator.getInstance().lookup(ScapptExportTransHVO.class);
  }
  ...
  public void getPk_sgroup_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_sgroup_s();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_sgroup_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String pk_sgroup_s=(String)dp.get("pk_sgroup_s").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setPk_sgroup_s(pk_sgroup_s);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getPk_zgroup_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_zgroup_s();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_zgroup_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String pk_zgroup_s=(String)dp.get("pk_zgroup_s").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setPk_zgroup_s(pk_zgroup_s);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getPk_borg_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_borg_s();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_borg_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String pk_borg_s=(String)dp.get("pk_borg_s").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setPk_borg_s(pk_borg_s);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getIbinpost_d(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    UFDouble retObj=null;
    retObj=scapptExportTransHVO.getIbinpost_d();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setIbinpost_d(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    nc.vo.pub.lang.UFDouble ibinpost_d=(nc.vo.pub.lang.UFDouble)super.getSpringObj("nc.vo.pub.lang.ufdouble");
    ibinpost_d.setTrimZero(Boolean.parseBoolean(dp.get("trimzero").get(0)));
    
    //Invoke tested method
    scapptExportTransHVO.setIbinpost_d(ibinpost_d);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getIbretired_d(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    UFDouble retObj=null;
    retObj=scapptExportTransHVO.getIbretired_d();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setIbretired_d(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    nc.vo.pub.lang.UFDouble ibretired_d=(nc.vo.pub.lang.UFDouble)super.getSpringObj("nc.vo.pub.lang.ufdouble");
    ibretired_d.setTrimZero(Boolean.parseBoolean(dp.get("trimzero").get(0)));
    
    //Invoke tested method
    scapptExportTransHVO.setIbretired_d(ibretired_d);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getIf_sus_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getIf_sus_s();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setIf_sus_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String if_sus_s=(String)dp.get("if_sus_s").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setIf_sus_s(if_sus_s);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getVwtranstype_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVwtranstype_s();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setVwtranstype_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String vwtranstype_s=(String)dp.get("vwtranstype_s").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setVwtranstype_s(vwtranstype_s);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getPk_main(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_main();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_main(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String newPk_main=(String)dp.get("newpk_main").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setPk_main(newPk_main);
  ...
  public void getPk_org(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_org();
  ...
  public void setPk_org(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setPk_org(newPk_org);
  ...
  public void getPk_group(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_group();
  ...
  public void setPk_group(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setPk_group(newPk_group);
  ...
  public void getBillmaker(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getBillmaker();
  ...
  public void setBillmaker(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setBillmaker(newBillmaker);
  ...
  public void getBillmakedate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    UFDate retObj=null;
    retObj=scapptExportTransHVO.getBillmakedate();
  ...
  public void setBillmakedate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setBillmakedate(newBillmakedate);
  ...
  public void getBillno(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getBillno();
  ...
  public void setBillno(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setBillno(newBillno);
  ...
  public void getCchangetype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getCchangetype();
  ...
  public void setCchangetype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setCchangetype(newCchangetype);
  ...
  public void getCtradetype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getCtradetype();
  ...
  public void setCtradetype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setCtradetype(newCtradetype);
  ...
  public void getVlevel(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVlevel();
  ...
  public void setVlevel(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVlevel(newVlevel);
  ...
  public void getPk_sgroup(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_sgroup();
  ...
  public void setPk_sgroup(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setPk_sgroup(newPk_sgroup);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getPk_zgroup(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_zgroup();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_zgroup(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String newPk_zgroup=(String)dp.get("newpk_zgroup").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setPk_zgroup(newPk_zgroup);
  ...
  public void getPk_borg(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_borg();
  ...
  public void setPk_borg(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setPk_borg(newPk_borg);
  ...
  public void getDbpercent(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDbpercent();
  ...
  public void setDbpercent(  Map<String,ArrayList<String>> dp){
    ...
    //Construct method parameters
    String newDbpercent=(String)dp.get("newdbpercent").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setDbpercent(newDbpercent);
  ...
  public void getVbaddress(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVbaddress();
  ...
  public void setVbaddress(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVbaddress(newVbaddress);
  ...
  public void getCbsetupdate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    UFDate retObj=null;
    retObj=scapptExportTransHVO.getCbsetupdate();
  ...
  public void setCbsetupdate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setCbsetupdate(newCbsetupdate);
  ...
  public void getDbcapital(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    UFDouble retObj=null;
    retObj=scapptExportTransHVO.getDbcapital();
  ...
  public void setDbcapital(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDbcapital(newDbcapital);
  ...
  public void getVbfactype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVbfactype();
  ...
  public void setVbfactype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVbfactype(newVbfactype);
  ...
  public void getIbinpost(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    Integer retObj=0;
    retObj=scapptExportTransHVO.getIbinpost();
  ...
  public void setIbinpost(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setIbinpost(newIbinpost);
  ...
  public void getIbretired(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    Integer retObj=0;
    retObj=scapptExportTransHVO.getIbretired();
  ...
  public void setIbretired(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setIbretired(newIbretired);
  ...
  public void getCbtransferflag(  Map<String,ArrayList<String>> dp){
    ...
    retObj=scapptExportTransHVO.getCbtransferflag();
  ...
  public void setCbtransferflag(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setCbtransferflag(newCbtransferflag);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getIf_sus(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    UFBoolean retObj=null;
    retObj=scapptExportTransHVO.getIf_sus();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setIf_sus(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    nc.vo.pub.lang.UFBoolean newIf_sus=(nc.vo.pub.lang.UFBoolean)super.getSpringObj("nc.vo.pub.lang.ufboolean");
    
    //Invoke tested method
    scapptExportTransHVO.setIf_sus(newIf_sus);
  ...
  public void getVbdetail(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    UFDouble retObj=null;
    retObj=scapptExportTransHVO.getVbdetail();
  ...
  public void setVbdetail(  Map<String,ArrayList<String>> dp){
    ...
    //Construct method parameters
    nc.vo.pub.lang.UFDouble newVbdetail=(nc.vo.pub.lang.UFDouble)super.getSpringObj("nc.vo.pub.lang.ufdouble");
    newVbdetail.setTrimZero(Boolean.parseBoolean(dp.get("trimzero").get(0)));
    
    //Invoke tested method
    scapptExportTransHVO.setVbdetail(newVbdetail);
  ...
  public void getVrname(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVrname();
  ...
  public void setVrname(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVrname(newVrname);
  ...
  public void getPk_rorg(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_rorg();
  ...
  public void setPk_rorg(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setPk_rorg(newPk_rorg);
  ...
  public void getDrcapital(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    UFDouble retObj=null;
    retObj=scapptExportTransHVO.getDrcapital();
  ...
  public void setDrcapital(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDrcapital(newDrcapital);
  ...
  public void getVrfactype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVrfactype();
  ...
  public void setVrfactype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVrfactype(newVrfactype);
  ...
  public void getPk_rgroup(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_rgroup();
  ...
  public void setPk_rgroup(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setPk_rgroup(newPk_rgroup);
  ...
  public void getVacceptno(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVacceptno();
  ...
  public void setVacceptno(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVacceptno(newVacceptno);
  ...
  public void getVwperiod(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVwperiod();
  ...
  public void setVwperiod(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVwperiod(newVwperiod);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getAtrdata(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getAtrdata();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setAtrdata(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String newAtrdata=(String)dp.get("newatrdata").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setAtrdata(newAtrdata);
  ...
  public void getDwprice(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    UFDouble retObj=null;
    retObj=scapptExportTransHVO.getDwprice();
  ...
  public void setDwprice(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDwprice(newDwprice);
  ...
  public void getCwtransflag(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    UFBoolean retObj=null;
    retObj=scapptExportTransHVO.getCwtransflag();
  ...
  public void setCwtransflag(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setCwtransflag(newCwtransflag);
  ...
  public void getVwtranstype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVwtranstype();
  ...
  public void setVwtranstype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVwtranstype(newVwtranstype);
  ...
  public void getDwtransprice(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    UFDouble retObj=null;
    retObj=scapptExportTransHVO.getDwtransprice();
  ...
  public void setDwtransprice(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDwtransprice(newDwtransprice);
  ...
  public void getVwassignname(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVwassignname();
  ...
  public void setVwassignname(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVwassignname(newVwassignname);
  ...
  public void getCwctdate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    UFDate retObj=null;
    retObj=scapptExportTransHVO.getCwctdate();
  ...
  public void setCwctdate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setCwctdate(newCwctdate);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getCwctdate_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getCwctdate_s();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setCwctdate_s(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String cwctdate_s=(String)dp.get("cwctdate_s").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setCwctdate_s(cwctdate_s);
  ...
  public void getVwpayment(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVwpayment();
  ...
  public void setVwpayment(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVwpayment(newVwpayment);
  ...
  public void getVsname(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVsname();
  ...
  public void setVsname(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVsname(newVsname);
  ...
  public void getPk_sorg(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_sorg();
  ...
  public void setPk_sorg(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setPk_sorg(newPk_sorg);
  ...
  public void getDscapital(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDscapital();
  ...
  public void setDscapital(  Map<String,ArrayList<String>> dp){
    ...
    //Construct method parameters
    String newDscapital=(String)dp.get("newdscapital").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setDscapital(newDscapital);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getAddress(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getAddress();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setAddress(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String newAddress=(String)dp.get("newaddress").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setAddress(newAddress);
  ...
  public void getPk_slgroup(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_slgroup();
  ...
  public void setPk_slgroup(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setPk_slgroup(newPk_slgroup);
  ...
  public void getPk_gorg(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_gorg();
  ...
  public void setPk_gorg(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setPk_gorg(newPk_gorg);
  ...
  public void getVcassesstype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getVcassesstype();
  ...
  public void setVcassesstype(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setVcassesstype(newVcassesstype);
  ...
  public void getTramethod(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getTramethod();
  ...
  public void setTramethod(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setTramethod(newTramethod);
  ...
  public void getMemo(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getMemo();
  ...
  public void setMemo(  Map<String,ArrayList<String>> dp){
    ...
    //Construct method parameters
    String newMemo=(String)dp.get("newmemo").get(0);
    
    //Invoke tested method
    scapptExportTransHVO.setMemo(newMemo);
  ...
  public void getTraname(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getTraname();
  ...
  public void setTraname(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setTraname(newTraname);
  ...
  public void getDef1(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDef1();
  ...
  public void setDef1(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDef1(newDef1);
  ...
  public void getDef2(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDef2();
  ...
  public void setDef2(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDef2(newDef2);
  ...
  public void getDef3(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDef3();
  ...
  public void setDef3(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDef3(newDef3);
  ...
  public void getDef4(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDef4();
  ...
  public void setDef4(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDef4(newDef4);
  ...
  public void getDef5(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDef5();
  ...
  public void setDef5(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDef5(newDef5);
  ...
  public void getDef6(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDef6();
  ...
  public void setDef6(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDef6(newDef6);
  ...
  public void getDef7(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDef7();
  ...
  public void setDef7(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDef7(newDef7);
  ...
  public void getDef8(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDef8();
  ...
  public void setDef8(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDef8(newDef8);
  ...
  public void getDef9(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDef9();
  ...
  public void setDef9(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDef9(newDef9);
  ...
  public void getDef10(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getDef10();
  ...
  public void setDef10(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDef10(newDef10);
  ...
  public void getListvalue(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    UFDouble retObj=null;
    retObj=scapptExportTransHVO.getListvalue();
  ...
  public void setListvalue(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setListvalue(newListvalue);
  ...
  public void getPk_bfirmbase_h(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPk_bfirmbase_h();
  ...
  public void setPk_bfirmbase_h(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setPk_bfirmbase_h(newPk_bfirmbase_h);
  ...
  public void getDr(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    Integer retObj=0;
    retObj=scapptExportTransHVO.getDr();
  ...
  public void setDr(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setDr(newDr);
  ...
  public void getTs(  Map<String,ArrayList<String>> dp){
    ...
    retObj=scapptExportTransHVO.getTs();
  ...
  public void setTs(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptExportTransHVO.setTs(newTs);
  ...
  public void getParentPKFieldName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getParentPKFieldName();
  ...
  public void getPKFieldName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getPKFieldName();
  ...
  public void getTableName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptExportTransHVO.getTableName();
  ...
  public void getDefaultTableName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=ScapptExportTransHVO.getDefaultTableName();
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    IVOMeta retObj=null;
    retObj=scapptExportTransHVO.getMetaData();
