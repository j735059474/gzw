...
public class ScapptTransferAssessVOTest extends BaseTestCase {
  ScapptTransferAssessVO scapptTransferAssessVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    scapptTransferAssessVO=NCLocator.getInstance().lookup(ScapptTransferAssessVO.class);
  }
  ...
  public void getPk_transfer_h(  Map<String,ArrayList<String>> dp){
    ...
    String retObj="";
    retObj=scapptTransferAssessVO.getPk_transfer_h();
  ...
  public void setPk_transfer_h(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptTransferAssessVO.setPk_transfer_h(newPk_transfer_h);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getPk_transfer_assess(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getPk_transfer_assess();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_transfer_assess(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String newPk_transfer_assess=(String)dp.get("newpk_transfer_assess").get(0);
    
    //Invoke tested method
    scapptTransferAssessVO.setPk_transfer_assess(newPk_transfer_assess);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getVproject(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getVproject();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setVproject(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String newVproject=(String)dp.get("newvproject").get(0);
    
    //Invoke tested method
    scapptTransferAssessVO.setVproject(newVproject);
  ...
  public void getVunit(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getVunit();
  ...
  public void setVunit(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptTransferAssessVO.setVunit(newVunit);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getPk_currency(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getPk_currency();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_currency(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String newPk_currency=(String)dp.get("newpk_currency").get(0);
    
    //Invoke tested method
    scapptTransferAssessVO.setPk_currency(newPk_currency);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getDcarryingvalue(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    UFDouble retObj=null;
    retObj=scapptTransferAssessVO.getDcarryingvalue();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setDcarryingvalue(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    nc.vo.pub.lang.UFDouble newDcarryingvalue=(nc.vo.pub.lang.UFDouble)super.getSpringObj("nc.vo.pub.lang.ufdouble");
    newDcarryingvalue.setTrimZero(Boolean.parseBoolean(dp.get("trimzero").get(0)));
    
    //Invoke tested method
    scapptTransferAssessVO.setDcarryingvalue(newDcarryingvalue);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getDassessvalue(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    UFDouble retObj=null;
    retObj=scapptTransferAssessVO.getDassessvalue();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setDassessvalue(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    nc.vo.pub.lang.UFDouble newDassessvalue=(nc.vo.pub.lang.UFDouble)super.getSpringObj("nc.vo.pub.lang.ufdouble");
    newDassessvalue.setTrimZero(Boolean.parseBoolean(dp.get("trimzero").get(0)));
    
    //Invoke tested method
    scapptTransferAssessVO.setDassessvalue(newDassessvalue);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getDchangepercent(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    UFDouble retObj=null;
    retObj=scapptTransferAssessVO.getDchangepercent();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setDchangepercent(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    nc.vo.pub.lang.UFDouble newDchangepercent=(nc.vo.pub.lang.UFDouble)super.getSpringObj("nc.vo.pub.lang.ufdouble");
    newDchangepercent.setTrimZero(Boolean.parseBoolean(dp.get("trimzero").get(0)));
    
    //Invoke tested method
    scapptTransferAssessVO.setDchangepercent(newDchangepercent);
  ...
  public void getVbdef5(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getVbdef5();
  ...
  public void setVbdef5(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptTransferAssessVO.setVbdef5(newVbdef5);
  ...
  public void getVbdef4(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getVbdef4();
  ...
  public void setVbdef4(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptTransferAssessVO.setVbdef4(newVbdef4);
  ...
  public void getVbdef3(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getVbdef3();
  ...
  public void setVbdef3(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptTransferAssessVO.setVbdef3(newVbdef3);
  ...
  public void getVbdef1(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getVbdef1();
  ...
  public void setVbdef1(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptTransferAssessVO.setVbdef1(newVbdef1);
  ...
  public void getVbdef2(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getVbdef2();
  ...
  public void setVbdef2(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptTransferAssessVO.setVbdef2(newVbdef2);
  ...
  public void getDr(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    Integer retObj=0;
    retObj=scapptTransferAssessVO.getDr();
  ...
  public void setDr(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptTransferAssessVO.setDr(newDr);
  ...
  public void getTs(  Map<String,ArrayList<String>> dp){
    ...
    retObj=scapptTransferAssessVO.getTs();
  ...
  public void setTs(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    scapptTransferAssessVO.setTs(newTs);
  ...
  public void getParentPKFieldName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getParentPKFieldName();
  ...
  public void getPKFieldName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getPKFieldName();
  ...
  public void getTableName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=scapptTransferAssessVO.getTableName();
  ...
  public void getDefaultTableName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=ScapptTransferAssessVO.getDefaultTableName();
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    IVOMeta retObj=null;
    retObj=scapptTransferAssessVO.getMetaData();
