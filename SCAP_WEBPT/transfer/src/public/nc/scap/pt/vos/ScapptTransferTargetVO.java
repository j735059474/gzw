...
public class ScapptTransferTargetVO extends SuperVO {
	private java.lang.String pk_transfer_h;
	private java.lang.String pk_transfer_target;
	...
	public static final String PK_TRANSFER_TARGET = "pk_transfer_target";
	...
	/**
	 * 属性pk_transfer_target的Getter方法.属性名：主键
	 * 创建日期:
	 * @return java.lang.String
	 */
	public java.lang.String getPk_transfer_target () {
		return pk_transfer_target;
	}   
	/**
	 * 属性pk_transfer_target的Setter方法.属性名：主键
	 * 创建日期:
	 * @param newPk_transfer_target java.lang.String
	 */
	public void setPk_transfer_target (java.lang.String newPk_transfer_target ) {
	 	this.pk_transfer_target = newPk_transfer_target;
	} 	  
	/**
    ...
    /**
	  ...
	  * 创建日期:
	  */
     public ScapptTransferTargetVO() {
		super();	
	}    
	
	@nc.vo.annotation.MDEntityInfo(beanFullclassName =  "nc.scap.pt.vos.ScapptTransferTargetVO" )
