 ...
 * 
 */
public class DataimpCardWinMainViewCtrl<T extends WebElement> extends
	...
	public void beforeShow(DialogEvent dialogEvent) {
		...
		} else if (AppConsts.OPE_EDIT.equals(oper) || "look".equals(oper)) {
			CmdInvoker.invoke(new UifDatasetLoadCmd(masterDs) {
				...
				protected void onAfterDatasetLoad() {
					...
					if (oper.equals("look")) {
						...
						CpUIctrl.showMenuBarReal(CpWinUtil.getView(),
								"menubar", new String[] { "save" });
					}
