...
<PageMeta i18nName="" caption="产权交易库列表"  controllerClazz="nc.scap.library.lib.LibListWinCtrl"  id="lib_listwin" sourcePackage="library/src/public/" windowType="win">
    ...
    <Connectors>
        ...
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="libraryComps.lib_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
