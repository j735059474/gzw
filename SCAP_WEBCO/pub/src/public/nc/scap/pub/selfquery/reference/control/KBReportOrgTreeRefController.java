...
public class KBReportOrgTreeRefController extends LfwSqlTreeReferenceController {
	...
	public LfwRefSqlVO getTreeSqlVO() {
		...
		String tbSql = "";
		String year_mon[] = CpFdUtil.getQryYearMonth("KB");
//		String qryorgs_swh = CpFdUtil.joinQryOrgsSwh("快报", year_mon[0], year_mon[1]);
//		if(isFilterOrg){
//				
...
//		}
		...
		tbSql=CpFdUtil.getReportSql("快报", year_mon[0], year_mon[1]);
