...
public class JJGcjsSxxwCaseInfoPortlet extends PtBasePortlet {

	private static final String TASK_LIST = "TASK_LIST";

	@Override
	protected void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException {
//		String newsType = request.getPreferences().getValue("newsType", "6");//动态获取portlet属性newsType
		Map<String,Object> root = new HashMap<String,Object>();
		NewsVO[] result = (NewsVO[]) ScapDAO.retrieveByCondition(NewsVO.class, " type = '6' and formstate = 'End' ", " ts desc ");
...
//		if(result.size() > 0){
			try {
				...
				String template = "portlets/JJGcjsSxxwCaseInfoPortlet.html";
