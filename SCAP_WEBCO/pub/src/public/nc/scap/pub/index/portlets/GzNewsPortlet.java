...
public class GzNewsPortlet extends PtBasePortlet {
	...
	protected void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException {
		...
		NewsVO[] result = (NewsVO[]) ScapDAO.retrieveByCondition(NewsVO.class, " type = '1' and formstate = 'End' ", " ts desc ");
...
//		if(article_list.length > 0){
			try {
				...
				String template = "portlets/GzNewsPortlet.html";
