...
<PageMeta i18nName="" caption="附件规则维护列表"  controllerClazz="nc.scap.pub.attlist.comp.manage.Attachrole_mgListWinCtrl"  id="attachrole_mg_listwin" sourcePackage="pub/src/public/" windowType="win">
    ...
    <Connectors>
        ...
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="attachrole_mgComps.attachrole_mg_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
