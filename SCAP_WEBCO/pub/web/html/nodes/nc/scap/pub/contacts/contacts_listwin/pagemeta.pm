...
<PageMeta i18nName="" caption="常用联系人列表"  controllerClazz="nc.scap.pub.contacts.ContactsListWinCtrl"  id="contacts_listwin" sourcePackage="pub/src/public/" windowType="win">
    ...
    <Connectors>
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="nc.scap.pub.contacts.contacts_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
