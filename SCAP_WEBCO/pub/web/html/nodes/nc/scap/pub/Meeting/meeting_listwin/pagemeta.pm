...
<PageMeta i18nName="" caption="会议管理列表"  controllerClazz="nc.scap.pub.meeting.MeetingListWinCtrl"  id="meeting_listwin" sourcePackage="pub/src/public/" windowType="win">
    ...
    <Connectors>
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="nc.scap.pub.Meeting.meeting_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
