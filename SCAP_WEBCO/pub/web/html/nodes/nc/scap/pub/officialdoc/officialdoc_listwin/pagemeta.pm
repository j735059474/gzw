...
<PageMeta i18nName="" caption="公文管理列表"  controllerClazz="nc.scap.pub.officialdoc.OfficialdocListWinCtrl"  id="officialdoc_listwin" sourcePackage="pub/src/public/" windowType="win">
    ...
    <Connectors>
        ...
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="nc.scap.pub.officialdoc.officialdoc_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
