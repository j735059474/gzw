...
<PageMeta i18nName="" caption="统一通知下发列表"  controllerClazz="nc.scap.pub.notice_manager.Notice_managerListWinCtrl"  id="notice_manager_listwin" sourcePackage="pub/src/public/" windowType="win">
    ...
    <Connectors>
        ...
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="nc.scap.pub.notice.notice_manager_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
