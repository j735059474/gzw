...
public class DsNewsPortlet extends PtBasePortlet {
	...
	protected void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException {
		...
		NewsVO[] result = (NewsVO[]) ScapDAO.retrieveByCondition(NewsVO.class, " type = '2' and formstate = 'End' ", " ts desc ");
...
//		if(result.size() > 0){
			try {
				...
				String template = "portlets/DsNewsPortlet.html";
