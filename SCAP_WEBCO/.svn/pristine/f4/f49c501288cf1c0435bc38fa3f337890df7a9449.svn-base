...
<PageMeta i18nName="" caption="即时通讯管理列表List"  controllerClazz="nc.scap.pub.messageing.MessageingListWinCtrl"  id="messageing_listwin" sourcePackage="pub/src/public/" windowType="win">
    ...
    <Connectors>
        ...
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="即时通讯.messageing_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
