...
public class YSReportOrgTreeRefController extends LfwSqlTreeReferenceController {
	...
	public LfwRefSqlVO getTreeSqlVO() {
		...
		String tbSql = "";
		String year_mon[] = CpFdUtil.getQryYearMonth("YS");
		//String qryorgs_swh = CpFdUtil.joinQryOrgsSwh("Ô¤Ëã", year_mon[0], year_mon[1]);
//		if(isFilterOrg){
//				
...
//		}
		...
		tbSql=CpFdUtil.getReportSql("Ô¤Ëã", year_mon[0], year_mon[1]);
