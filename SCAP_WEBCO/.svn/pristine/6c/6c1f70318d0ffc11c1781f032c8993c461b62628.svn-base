 ...
 * 卡片窗口默认逻辑
 */
public class TemplateCardWinMainViewCtrl<T extends WebElement> extends AbstractMasterSlaveViewController {
 ...
 */
  ...
  public void onDataLoad_scapco_template(  DataLoadEvent dataLoadEvent){
