...
<PageMeta i18nName="" caption="模版配置列表List"  controllerClazz="nc.scap.pub.template.TemplateListWinCtrl"  id="template_listwin" sourcePackage="pub/src/public/" windowType="win">
    ...
    <Connectors>
        ...
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="nc.scap.pub.pub_uiComps_template.template_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
