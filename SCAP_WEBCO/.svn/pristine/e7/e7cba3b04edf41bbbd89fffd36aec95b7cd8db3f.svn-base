...
public class JSReportOrgTreeRefController extends LfwSqlTreeReferenceController {
	...
	public LfwRefSqlVO getTreeSqlVO() {
		...
		String tbSql = "";
		String year_mon[] = CpFdUtil.getQryYearMonth("JS");
		//String qryorgs_swh = CpFdUtil.joinQryOrgsSwh("¾öËã", year_mon[0], year_mon[1]);
//		if(isFilterOrg){
//				
...
//							"cp_orgs";
//		}
		tbSql=CpFdUtil.getReportSql("¾öËã", year_mon[0], year_mon[1]);
