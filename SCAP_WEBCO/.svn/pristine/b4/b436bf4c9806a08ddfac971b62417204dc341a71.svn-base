...
public class JJCaseInfoPortlet extends PtBasePortlet {

	private static final String TASK_LIST = "TASK_LIST";

	@Override
	protected void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException {
//		String newsType = request.getPreferences().getValue("newsType", "5");//动态获取portlet属性newsType
		Map<String,Object> root = new HashMap<String,Object>();
		NewsVO[] result = (NewsVO[]) ScapDAO.retrieveByCondition(NewsVO.class, " type = '5' and formstate = 'End' ", " ts desc ");
...
//		if(result.size() > 0){
			try {
				...
				String template = "portlets/JJCaseInfoPortlet.html";
