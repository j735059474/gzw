...
<PageMeta i18nName="" caption="人员选择列表"  controllerClazz="nc.scap.pub.choice.ChoiceListWinCtrl"  id="choice_listwin" sourcePackage="pub/src/public/" windowType="win">
    ...
    <Connectors>
        ...
        <Connector connType="8" id="proxyin_refreshProxy_refresh_plugin" pluginId="refresh_plugin" plugoutId="refreshProxy" source="nc.scap.pub.choiceComps.choice_listwin" sourceWindow="" target="main" targetWindow="">
        </Connector>
