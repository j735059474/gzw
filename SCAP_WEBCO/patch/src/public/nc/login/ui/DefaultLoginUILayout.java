...
public class DefaultLoginUILayout implements LayoutManager {
	...
	public void layoutContainer(Container parent) {
		synchronized (parent.getTreeLock()) {
			...
			int maxW = 0;
			Component[] lblComps = {uiSupport.getLblBusiCenter(),uiSupport.getLblUserCode(), uiSupport.getLblPWD(), uiSupport.getLblSmsCode()};
			Component[] ctrlComps = {uiSupport.getCbbBusiCenter(),uiSupport.getTfUserCode(), uiSupport.getPfUserPWD(), uiSupport.getTfSmsCode()};
			...
			Component smsCodeBtn = uiSupport.getBtnSmsCode();
			smsCodeBtn.setBounds(x + 110, y - 35 - 11,150,35);
