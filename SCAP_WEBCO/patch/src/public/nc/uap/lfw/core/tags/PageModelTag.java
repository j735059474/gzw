...
//				addJsonSupport(scriptBuf, request, pageMeta);
			...
			if(Logger.isInfoEnabled()){
				...
				Logger.info(LfwResBundle.getInstance().getStrByID("bc", "PageModelTag-000000")/*初始化PageMode:"*/ + modelId + LfwResBundle.getInstance().getStrByID("bc", "PageModelTag-000001")/*"所用时间:*/ + (endTime - startTime) + "ms");
			}
